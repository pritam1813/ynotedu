...
import { CourseWithInstructor } from ".";

export default function CourseCard({ data }: { data: CourseWithInstructor }) {
        ...
        <div className="coursesCard -type-1">
          ...
          <div className="h-100 pt-15">
            <div className="d-flex items-center">
              ...
              <div className="text-13 lh-1 ml-10">({data.rating})</div>
            </div>
            ...
            <div className="d-flex x-gap-10 items-center pt-10">
              <div className="d-flex items-center">
                ...
                <div className="text-14 lh-1">{data.lessons} lesson</div>
              </div>
            ...
            <div className="coursesCard-footer">
              <div className="coursesCard-footer__author">
                <Image
                  width={30}
                  height={30}
                  // src="/assets/img/general/avatar-1.png" //data.instructor.image
                  src={
                    data.instructor.image || "/assets/img/general/avatar-1.png"
                  }
                  alt="image"
                />
                <div>
