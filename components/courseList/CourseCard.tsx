    ...
    <div className="side-content col-xl-4 col-lg-6 col-md-4 col-sm-6">
      <div className="coursesCard -type-1">
        ...
        <div className="h-100 pt-15">
          <div className="d-flex items-center">
            ...
            <div className="text-13 lh-1 ml-10">({course.ratingCount})</div>
          </div>
          ...
          <div className="d-flex x-gap-10 items-center pt-10">
            <div className="d-flex items-center">
              ...
              <div className="text-14 lh-1">{course.lessonCount} lesson</div>
            </div>
      ...
      <div className="side-content__item">
        <div className="px-30 pt-20 pb-30 bg-white rounded-8 border-light shadow-2">
          <div className="text-18 lh-16 text-dark-1">{course.title}</div>
